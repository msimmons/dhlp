...
public abstract class JDBCObject {
   ...
   */
   public static JDBCObject create(ResultSet row) throws SQLException {
   ...
   // Methods
   //
   public final String getCatalog() { return this.catalog; }
   public final String getSchema() { return this.schema; }
   public final String getName() { return this.name; }
   public final String getType() { return this.type; }
   public final boolean isDescribed() { return this.described; }
   public final void setDescribed() { this.described = true; }
   public final String getDisplayName() { return this.name+" ("+this.type+" "+((this.catalog==null)?"":this.catalog+".")+this.schema+")"; }
